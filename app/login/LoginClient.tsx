      ...
      <div className="max-w-md w-full bg-white dark:bg-stone-900 rounded-3xl shadow-xl border border-stone-200 dark:border-stone-800 p-8 sm:p-10 relative z-10 transition-colors">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-1.5">
            <label className="block text-sm font-medium tracking-wide text-stone-700 dark:text-stone-300">Nomor Telepon / Email</label>
            <input
              type="text"
              value={phone}
        ...
        <p className="mt-8 text-center text-sm text-stone-600 dark:text-stone-300 font-light">
          Belum punya akun?{" "}
