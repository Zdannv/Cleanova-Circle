...
export default async function Home() {
  ...
  const content = {
    ...
    // Education Section (Section 3) - using featureSubtitle/featureTitle for CMS editability
    eduSubtitle: landingPage?.featureSubtitle || "Cleanova Circle",
    eduTitle: landingPage?.featureTitle || "Gabung Cleanova Circle: Ribuan Tips & Video Panduan Merawat Barang Kesayangan Anda Gratis!",
  ...
  return (
    <div className="min-h-screen bg-[#fafaf9] text-stone-900 font-sans selection:bg-amber-500 selection:text-white dark:bg-stone-950 dark:text-stone-50">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {products.length === 0 ? (
            <div className="border border-dashed border-stone-300 dark:border-stone-850 rounded-3xl py-16 text-center">
              <p className="text-stone-500 dark:text-stone-450 font-light">Belum ada produk yang tersedia saat ini.</p>
      ...
      <section className="py-24 relative overflow-hidden bg-gradient-to-br from-amber-50 via-white to-amber-50/30 dark:from-stone-950 dark:via-stone-900/50 dark:to-stone-950">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-amber-300/10 rounded-full blur-3xl pointer-events-none dark:bg-amber-900/5"></div>
        
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 space-y-8">
          <span className="text-amber-600 dark:text-amber-500 text-xs font-semibold tracking-wider uppercase bg-amber-100/60 dark:bg-amber-950/50 border border-amber-200/50 dark:border-amber-900/30 px-3.5 py-1.5 rounded-full">
            Edukasi &amp; Komunitas
          </span>
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif font-light text-stone-900 dark:text-white leading-tight">
            {content.eduSubtitle}
          </h2>
          <div className="w-16 h-px bg-amber-500 mx-auto"></div>
          
          <p className="text-lg md:text-xl text-stone-705 dark:text-stone-300 font-light leading-relaxed max-w-2xl mx-auto">
            {content.eduTitle}
          </p>
          ...
          <div className="pt-6">
            <Link
              href="/register"
              className="inline-flex items-center justify-center gap-3 px-10 py-5 text-sm uppercase tracking-widest font-extrabold text-stone-900 bg-amber-400 hover:bg-amber-500 active:scale-95 duration-150 rounded-2xl shadow-xl shadow-amber-500/20 hover:shadow-amber-500/40 hover:-translate-y-0.5 transition-all text-center dark:text-stone-950"
            >
